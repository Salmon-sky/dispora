            ...
            <div className="row">
              <div className="col-2 mt-4">
                <div className="d-flex flex-column">
                  ...
                  <Link to={"/dashboard_admin_proposal"} className="btn btn-kembali-surat mb-4">
                    {"<"} Kembali
                  </Link>
                </div>     
              </div>
              ...
              {/*<form className="px-4">
                <div className="row align-items-start">
                  ...
                  <Link to={"/dashboard_admin_proposal"} className="btn btn-kembali-surat mb-4 mt-2">
                    {"<"} Kembali
                  </Link>
                  <Link to={"/dashboard_admin_proposal"} className="btn btn-kembali-surat mb-4">
                    {"<"} Kembali
...
export default ProfilAdminProposal;
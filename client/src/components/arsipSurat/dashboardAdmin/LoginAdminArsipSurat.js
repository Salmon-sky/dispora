  ...
  return (
    <div className="container-fluid ps-md-0">
      <div className="row g-0">
        <div
          className="d-none d-md-flex col-md-4 col-lg-4 bg-image"
          style={{ backgroundImage: `url(${gambarHalamanLogin})` }}
        ></div>
                  ...
                  <div className="card card-login">
                    ...
                    <form onSubmit={handleLogin}>
                      <div className="form-group mb-3">
                        <label htmlFor="username" className="label-login mb-1">
                          Username
                        </label>
                        <input
                          type="text"
...
export default LoginAdminArsipSurat;
